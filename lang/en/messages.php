...
return [
    ...
    'message.open_page' => 'See the page',
    ...
    'book.bulk.toolbar_label' => 'Bulk actions',
    'book.bulk.hint' => 'Tap pages to select them',
    'book.bulk.selected_count' => ':count selected',
    'book.bulk.select_all' => 'Select all',
    'book.bulk.clear' => 'Clear',
    'book.bulk.close' => 'Done selecting',
    'book.bulk.move_to_top' => 'Move to top',
    'book.bulk.move_to_book' => 'Move to book',
    'book.bulk.delete' => 'Delete',
    'book.bulk.select_page_aria' => 'Select page :number',
    'book.bulk.confirm_delete_title' => 'Delete the selected pages?',
    'book.bulk.confirm_delete_message' => 'The selected pages will be deleted forever. This cannot be undone.',
    'book.bulk.confirm_move_top_title' => 'Move the selected pages to the top?',
    'book.bulk.confirm_move_top_message' => 'The selected pages will be moved to the top of this book.',
    'book.bulk.confirm_move_book_title' => 'Move the selected pages to another book',
    'book.bulk.confirm_move_book_message' => 'Pick the book the selected pages should move to.',
    'book.bulk.search_books' => 'Search books',
    'book.bulk.no_books' => 'No books found',
    'book.bulk.error' => 'Something went wrong. Please try again.',
