...
class MessageController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        $messages = Message::with(['user', 'page', 'song', 'book.coverImage', 'reactions.user', 'comments.user', 'comments.reactions.user'])
    ...
    {
        $message->load(['user', 'page', 'song', 'book.coverImage', 'reactions.user', 'comments.user', 'comments.reactions.user']);
