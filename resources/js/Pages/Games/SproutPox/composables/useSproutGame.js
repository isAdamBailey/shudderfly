...
const LAUNCH_Y_FRAC = 0.65; // sprout starting position, fraction of stage height
// Kept clear below the sprout's resting spot so a full-power pull-back
// (MAX_DRAG) never drags the sprout below the visible stage.
const LAUNCH_BOTTOM_MARGIN = MAX_DRAG + 20;
