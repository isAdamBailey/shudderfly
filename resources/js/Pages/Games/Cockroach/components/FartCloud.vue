    ...
    <div v-if="visible" class="fart-overlay">
        ...
        >
            ...
            >
                <animate
                    attributeName="d"
                    values="M60,45 Q55,35 60,25;M60,45 Q65,35 60,25;M60,45 Q55,35 60,25"
                    dur="1.5s"
                    repeatCount="indefinite"
                />
            </path>
            <path
                d="M95,40 Q90,28 95,18"
                fill="none"
                stroke="#8ba834"
                stroke-width="2.5"
                stroke-linecap="round"
            ...
            >
                <animate
                    attributeName="d"
                    values="M95,40 Q90,28 95,18;M95,40 Q100,28 95,18;M95,40 Q90,28 95,18"
                    dur="1.8s"
                    repeatCount="indefinite"
                />
            </path>
            <path
                d="M130,48 Q125,36 130,26"
                fill="none"
                stroke="#8ba834"
                stroke-width="2.5"
                stroke-linecap="round"
            ...
            >
                <animate
                    attributeName="d"
                    values="M130,48 Q125,36 130,26;M130,48 Q135,36 130,26;M130,48 Q125,36 130,26"
                    dur="1.3s"
                    repeatCount="indefinite"
                />
            </path>
