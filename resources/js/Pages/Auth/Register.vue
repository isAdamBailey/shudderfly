    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
              ...
              <TextInput id="registration_secret" type="text" class="mt-1 block w-full" v-model="form.registration_secret"/>
              <InputError class="mt-2" :message="form.errors.registration_secret" />
            </div>
