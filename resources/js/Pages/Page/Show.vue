<template>
  ...
  <BreezeAuthenticatedLayout>
    <div class="relative">
      <div class="w-full pl-2 sm:pl-6 lg:pl-8 pt-2 sticky top-0 z-30 text-left">
        <div class="flex items-center gap-3 min-w-0">
          <button
            type="button"
            class="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-blue-600 text-white dark:bg-white dark:text-gray-900 hover:bg-blue-500 dark:hover:bg-gray-100 shadow focus:outline-none focus:ring-2 focus:ring-blue-500 transition min-w-0 max-w-[90vw] sm:max-w-[70vw] md:max-w-[60vw] lg:max-w-[50vw] disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-400 dark:disabled:bg-gray-600"
