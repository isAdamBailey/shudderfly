            ...
            <div class="space-y-4">
                ...
                >
                    ...
                    <p class="text-sm text-blue-800 dark:text-blue-200">
                        This image is currently the cover for this book. To
                        change it, open another page and use "Make Cover Image"
                        there.
                    </p>
                </div>
                <div v-else-if="isImagePage" class="flex flex-col gap-2">
                    ...
                    >
                        <SecondaryButton
                            type="button"
                            @click="toggleCoverPagePending"
                        >
                            <i
                                class="ri-image-line mr-2"
                                aria-hidden="true"
                            ></i>
                            {{
                                pendingCoverPage
                ...
                <div
                    ...
                    :class="
                        hasCoverAction
                            ? 'border-t border-gray-100 dark:border-gray-700/60 pt-4'
                            : ''
                    "
                >
                    <div
