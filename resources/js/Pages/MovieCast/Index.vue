...
const currentFavoriteMovie = computed(() => {
    ...
    return {
        ...
        image_path:
            movieDetails.value.poster_path || movieDetails.value.backdrop_path,
    };
});
...
const isCurrentMovieFavorite = computed(() => {
    ...
    return favoritesList.value.some(
        (movie) => movie.id === movieDetails.value.id
    );
});
...
const getProfileImageUrl = (profilePath) =>
    `${props.tmdbImageBaseUrl}${profilePath}`;
...
const speakCharacter = (member) => {
    ...
    const characterName =
        member.character?.trim() || t("movie.unknown_character");
    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="space-y-8">
                ...
                <div
                    v-if="searchResults.length && !movieDetails"
                    class="space-y-3"
                >
                    <h3 class="text-lg font-semibold text-gray-100">
                ...
                <div v-if="movieDetails" class="space-y-6">
                    ...
                    >
                        <i
                            class="ri-arrow-left-line text-lg mr-2"
                            aria-hidden="true"
                        ></i>
                    ...
                    <div class="rounded-lg bg-gray-800 p-4 sm:p-6">
                        <div class="flex flex-col md:flex-row gap-6">
                            <img
                                ...
                                :src="
                                    getMovieImageUrl(movieDetails.poster_path)
                                "
                            ...
                            <div class="flex-1 space-y-3">
                                ...
                                <div class="flex justify-end">
                                    <SpeakButton
                                        :disabled="speaking"
                                        :aria-label="
                                            t('movie.speak_description_aria')
                                        "
                        ...
                        <div class="mt-6">
                            ...
                            <img
                                ...
                                :src="
                                    getMovieImageUrl(movieDetails.backdrop_path)
                                "
                                :alt="movieDetails.title"
