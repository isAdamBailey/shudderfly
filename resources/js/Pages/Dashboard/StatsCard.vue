    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
      ...
      >
        ...
        <div class="flex items-center">
          <Button
            ...
            @click="
              speak(
                `all books: ${statsData.numberOfBooks?.toLocaleString?.() ?? 0}`
              )
            "
          >
      ...
      >
        ...
        <div class="flex items-center">
          <Button
            ...
            @click="
              speak(
                `all pages: ${statsData.numberOfPages?.toLocaleString?.() ?? 0}`
              )
            "
          >
            <i class="ri-speak-fill text-lg"></i>
      ...
      >
        ...
        <div class="flex items-center">
          <Button
            ...
            @click="
              speak(
                `songs: ${statsData.numberOfSongs?.toLocaleString?.() ?? 0}`
              )
            "
          >
            <i class="ri-speak-fill text-lg"></i>
      ...
      >
        ...
        <div class="flex items-center">
          <Button
            ...
            @click="
              speak(
                `images: ${statsData.numberOfImages?.toLocaleString?.() ?? 0}`
              )
            "
          >
            <i class="ri-speak-fill text-lg"></i>
      ...
      >
        ...
        <div class="flex items-center">
          <Button
            ...
            @click="
              speak(
                `videos: ${statsData.numberOfVideos?.toLocaleString?.() ?? 0}`
              )
            "
          >
            <i class="ri-speak-fill text-lg"></i>
      ...
      >
        ...
        >
          ...
          <div>
            <div class="text-base text-gray-500">YouTube videos</div>
            <div class="font-bold text-2xl">
        ...
        <div class="flex items-start">
          ...
          <div class="flex-1">
            <div class="flex items-center justify-between">
              <div>
                <div class="text-sm text-gray-500">Book with most pages</div>
                <Link
                  ...
                  @click="
                    speak(
                      `Book with most pages: ${
                        statsData.mostPages?.title || ''
                      }. ${statsData.mostPages?.pages_count || 0} pages.`
                    )
                  "
                >
                  <i class="ri-speak-fill text-lg"></i>
      ...
      <div class="bg-white dark:bg-gray-800 border rounded-lg p-4 shadow-sm">
        <div class="flex items-start">
          ...
          <div class="flex-1">
            <div class="flex items-center justify-between">
              <div>
                <div class="text-sm text-gray-500">Book with least pages</div>
                <Link
                  class="font-bold hover:text-blue-400 truncate block"
                ...
                <div class="text-sm text-gray-500 mt-1">
                  {{
                    countAddS(statsData.leastPages?.pages_count || 0, "page")
                  }}
                </div>
              </div>
