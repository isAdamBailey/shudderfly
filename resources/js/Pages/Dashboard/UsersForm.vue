    ...
    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
      <div class="inline-block min-w-full sm:px-6 lg:px-8">
        <p class="text-gray-700 dark:text-gray-100 mb-3">
          This is where you can manage other users, as an administrator of this
          application.
        </p>
        <ul class="text-gray-700 dark:text-gray-100">
          <li>
            Making someone an <strong>admin</strong> lets them edit other users
            (including you)! They have access to this page.
          </li>
          <li>
            Allowing someone to <strong>edit pages</strong> gives them access to
            add, edit and delete books and pages.
          </li>
          <li>
            Allowing someone to <strong>edit profile</strong> gives them access
            to edit and delete their own profile and the ability to log out of
            the application.
          </li>
        </ul>
                ...
                <td>
                  <div v-if="userIsAdmin(user)">
                    <Button
                      ...
                      @click="removePermission(user, 'admin')"
                    >
                      Revoke Admin
                    </Button>
                  </div>
                  <div v-else class="my-1">
                    <DangerButton @click="addPermission(user, 'admin')"
                  ...
                  <div v-if="userCanEditPages(user)">
                    <Button
                      ...
                      @click="removePermission(user, 'edit pages')"
                    >
                      Revoke Edit Pages
                    </Button>
                  </div>
                  <div v-else class="my-1">
                    <DangerButton @click="addPermission(user, 'edit pages')"
                      >Allow Edit Pages</DangerButton
                    >
                  </div>
                  <div v-if="userCanEditProfile(user)">
                    <Button
                      ...
                      @click="removePermission(user, 'edit profile')"
                    >
                      Revoke Profile Editing
                    </Button>
                  </div>
                  <div v-else>
                    <DangerButton @click="addPermission(user, 'edit profile')"
