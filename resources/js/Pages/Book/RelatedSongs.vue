<template>
    <div v-if="songs.length > 0">
        <h3 class="mb-3 text-2xl text-theme-title font-heading">
            {{ label }}
        </h3>
        <div
        ...
        >
            ...
            >
                <div
                    class="relative w-full aspect-video bg-gray-200 dark:bg-gray-900"
                >
                    <img
                    ...
                    >
                        <i
                            class="ri-music-2-line text-4xl text-gray-400 dark:text-gray-500"
                        ></i>
                    </div>
                </div>
                <div class="p-2">
