    ...
    describe("Theme Switching", () => {
        ...
        describe("Fireworks Theme", () => {
            ...
            it("includes firework-specific elements", () => {
                ...
                expect(firework.find("circle[fill='yellow']").exists()).toBe(
                    true
                );
                expect(firework.find("circle[fill='orange']").exists()).toBe(
                    true
                );
    ...
    describe("SVG Structure", () => {
        it("maintains consistent outer structure across all themes", () => {
            ...
            themes.forEach((theme) => {
                ...
                expect(svg.attributes("xmlns")).toBe(
                ...
                expect(
                    svg.findAll("circle[fill='white']").length
                ).toBeGreaterThan(0);
            });
        });
