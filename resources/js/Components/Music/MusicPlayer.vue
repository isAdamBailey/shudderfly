    ...
    >
            ...
            <div class="flex flex-col items-center space-y-4">
                    ...
                    >
                        <div class="flex items-end space-x-1 h-20">
                            <div
                                v-for="i in 20"
                                :key="i"
                                class="visualizer-bar bg-indigo-500/70 dark:bg-indigo-400/70 w-1.5 rounded-full"
                                :style="{
                ...
                <div class="w-full min-w-0 space-y-4">
                    ...
                    >
                        ...
                        >
                            <div
                                class="bg-indigo-600 dark:bg-indigo-500 h-3 rounded-full"
                                :class="{
                            ...
                            ></div>
                            <div
                                class="absolute top-1/2 w-5 h-5 -ml-2.5 -translate-y-1/2 rounded-full bg-white dark:bg-gray-100 border-2 border-indigo-600 dark:border-indigo-500 shadow pointer-events-none"
                                :class="{
                                    'transition-all duration-100': !isScrubbing,
                    ...
                    <div class="flex flex-col items-center gap-3">
                        ...
                        >
                            ...
                            <button
                                class="w-16 h-16 shrink-0 bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-700 dark:hover:bg-indigo-600 text-white rounded-full flex items-center justify-center transition-all duration-200 shadow-lg"
                                :disabled="isLoading"
        ...
        >
            <div class="flex flex-col items-center">
                <i
                    class="ri-loader-4-line animate-spin text-indigo-600 text-4xl mb-2"
                ></i>
