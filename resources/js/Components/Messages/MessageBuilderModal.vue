<template>
    <Modal :show="show" max-width="2xl" @close="$emit('close')">
        <div class="flex flex-col" style="max-height: 85vh; max-height: 85dvh">
            ...
            <div
                class="p-4 pb-3 sm:p-6 sm:pb-4 max-h-[45vh] overflow-y-auto border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800"
            >
                <MessageBuilder
                    v-if="show"
            ...
            <div class="flex-1 overflow-y-auto p-6 pt-4 min-h-0">
                ...
                >
                    ...
                    <div class="mb-4">
                        ...
                        >
                            <i
                                class="ri-gift-fill text-orange-600 text-2xl"
                            ></i>
                    ...
                    <div class="mb-4">
                        ...
                        >
                            <i
                                class="ri-user-fill text-purple-600 text-2xl"
                            ></i>
                            {{ t("flyout.people") }}
                        </div>
                        <div class="flex flex-wrap gap-2">
                    ...
                    <div class="mb-4">
                        ...
                        >
                            <i
                                class="ri-body-scan-fill text-red-600 text-2xl"
                            ></i>
                            {{ t("flyout.body_parts") }}
                        </div>
                        <div class="flex flex-wrap gap-2">
                    ...
                    <div class="mb-4">
                        ...
                        >
                            <i
                                class="ri-contrast-fill text-indigo-600 text-2xl"
                            ></i>
                            {{ t("flyout.how_much") }}
                        </div>
                        <div class="flex flex-wrap gap-2">
