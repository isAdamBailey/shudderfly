    ...
    <div ref="timelineContainer" class="space-y-4">
        ...
        >
            ...
            <div class="w-full">
                ...
                <div
                    v-if="message.song_id && message.song"
                    class="mt-2 md:mt-3"
                >
                    <button
                        type="button"
            ...
            >
                ...
                <div
                    v-if="
                        getCommentCount(message) === 0 &&
                        !isCommentModalOpenFor(message.id)
                    "
                ...
                <template v-else>
                    ...
                    >
                        ...
                        <CommentItem
                            ...
                            "
                            @view-reactions="
                                openViewCommentReactionsModal(comment)
                            "
                        />
...
const speakViewReactions = () => {
    ...
    const reactionTexts = selectedReactions
        .map((emoji) => {
            ...
            return t("message.reaction_from", {
                emoji: emojiName,
