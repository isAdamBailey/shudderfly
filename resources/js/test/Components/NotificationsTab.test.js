...
describe("NotificationsTab", () => {
    ...
    describe("Mark as read", () => {
        ...
        it("calls API when mark as read is clicked", async () => {
            ...
            const unreadNotification = wrapper.vm.notifications?.find(n => !n.read_at);
            ...
            if (unreadNotification) {
                ...
                if (axios.post.mock.calls.length > 0) {
                    ...
                    expect(callArgs[0]).toMatch(/notifications.*read|read.*notifications/i);
                }
            } else {
        ...
        it("updates notification to read state after marking", async () => {
            ...
            if (unreadNotification) {
                ...
                const updatedNotification = wrapper.vm.notifications.find(n => n.id === unreadNotification.id);
